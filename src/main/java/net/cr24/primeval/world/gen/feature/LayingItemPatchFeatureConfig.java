...
public record LayingItemPatchFeatureConfig(IntProvider tries, IntProvider xzSpread, IntProvider ySpread, ItemStack itemSource) implements FeatureConfig {
    ...
    public static final Codec<LayingItemPatchFeatureConfig> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(
                ...
                ItemStack.CODEC.fieldOf("item").forGetter(LayingItemPatchFeatureConfig::itemSource)
