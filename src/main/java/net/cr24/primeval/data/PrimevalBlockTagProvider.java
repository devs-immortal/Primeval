...
public class PrimevalBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void generateTags() {
        ...
        for (Block block : PrimevalBlocks.COPPER_MALACHITE_ORE) getOrCreateTagBuilder(PrimevalBlockTags.COPPER_ORES).add(block);
        for (Block block : PrimevalBlocks.COPPER_NATIVE_ORE) getOrCreateTagBuilder(PrimevalBlockTags.COPPER_ORES).add(block);
        for (Block block : PrimevalBlocks.IRON_HEMATITE_ORE) getOrCreateTagBuilder(PrimevalBlockTags.IRON_ORES).add(block);
        for (Block block : PrimevalBlocks.TIN_CASSITERITE_ORE) getOrCreateTagBuilder(PrimevalBlockTags.TIN_ORES).add(block);
        for (Block block : PrimevalBlocks.ZINC_SPHALERITE_ORE) getOrCreateTagBuilder(PrimevalBlockTags.ZINC_ORES).add(block);
        for (Block block : PrimevalBlocks.SMOOTH_STONE) getOrCreateTagBuilder(PrimevalBlockTags.SMOOTH_STONE_BLOCKS).add(block);
        for (Block block : PrimevalBlocks.STONE_BRICKS) getOrCreateTagBuilder(PrimevalBlockTags.STONE_BRICKS).add(block);
        for (Block block : PrimevalBlocks.FIRED_CLAY_SHINGLE_BLOCKS) getOrCreateTagBuilder(PrimevalBlockTags.FIRED_SHINGLE_BLOCKS).add(block);
        for (Block block : PrimevalBlocks.FIRED_CLAY_BRICK_BLOCKS) getOrCreateTagBuilder(PrimevalBlockTags.FIRED_BRICKS).add(block);
        for (Block block : PrimevalBlocks.FIRED_CLAY_TILES_BLOCKS) getOrCreateTagBuilder(PrimevalBlockTags.FIRED_TILE_BLOCKS).add(block);
        for (Block block : PrimevalBlocks.DRIED_BRICK_BLOCKS) getOrCreateTagBuilder(PrimevalBlockTags.DRIED_BRICKS).add(block);
