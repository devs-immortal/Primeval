...
public class PrimevalBlockStateModelGenerator {

    public static void register(BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerSingleton(Block block, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerParentedSingleton(Block block, Block parent, BlockStateModelGenerator modelGenerator) {
        Identifier model = ModelIds.getBlockModelId(parent);
        modelGenerator.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(block, model));
    }

    public static void registerParentedSingletonWithoutItem(Block block, Block parent, BlockStateModelGenerator modelGenerator) {
        Identifier model = ModelIds.getBlockModelId(parent);
        modelGenerator.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(block, model));
        modelGenerator.excludeFromSimpleItemModelGeneration(block);
    }

    public static void registerRandomMirroredInversion(Block block, BlockStateModelGenerator modelGenerator) {
        Identifier model = ModelIds.getBlockModelId(block);
    ...
    public static void registerLayered(Block layerBlock, Block fullBlock, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerBlockSet(PrimevalBlocks.BlockSet blockSet, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerWoodBlockSet(PrimevalBlocks.WoodBlockSet woodBlockSet, Block texture, Block doorTexture, Block trapdoorTexture, boolean orientableTrapdoor, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerOreBlockSet(PrimevalBlocks.OreBlockSet oreBlockSet, BlockStateModelGenerator modelGenerator) {
        for (Block block : oreBlockSet) modelGenerator.registerSingleton(block, TexturedModel.CUBE_ALL);
    }

    public static void registerAshPile(Block block, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerRope(Block block, BlockStateModelGenerator modelGenerator) {
        modelGenerator.registerAxisRotated(block, ModelIds.getBlockModelId(block));
        modelGenerator.registerItemModel(block.asItem());
    }

    public static void registerRopeLadder(Block block, BlockStateModelGenerator modelGenerator) {
        modelGenerator.registerNorthDefaultHorizontalRotation(block);
        modelGenerator.registerItemModel(block);
    }

    public static void registerFlower(Block block, Block parent, BlockStateModelGenerator modelGenerator) {
        Identifier model = ModelIds.getBlockModelId(parent);
        modelGenerator.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(block, model));
        Models.GENERATED.upload(ModelIds.getItemModelId(block.asItem()), TextureMap.layer0(parent), modelGenerator.modelCollector);
    }

    public static void registerGrass(Block block, Block parent, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerGrassyDirt(Block block, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerBush(Block block, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerShrub(Block block, BlockStateModelGenerator modelGenerator) {
        Identifier model = ModelIds.getBlockModelId(block);
        modelGenerator.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(block, model));
        modelGenerator.registerItemModel(block.asItem());
    }

    public static void registerCrate(Block block, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerLogFence(Block logFence, Block fence, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerFence(Block fence, Block texture, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerFenceGate(Block fenceGate, Block texture, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerSlab(Block slab, Block texture, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerStairs(Block stairs, Block texture, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerPillarSlab(Block slab, Block texture, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerPillarStairs(Block stairs, Block texture, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerDoor(Block door, Block texture, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerTrapdoor(Block trapdoor, Block texture, boolean orientable, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerLog(Block log, Block trunk, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerTrunk(Block block, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerCampfire(Block block, BlockStateModelGenerator modelGenerator) {
        Identifier _0 = ModelIds.getBlockSubModelId(block, "_0");
    ...
    public static void registerTorch(Block block, BlockStateModelGenerator modelGenerator) {
    ...
    public static void registerPitKiln(Block block, BlockStateModelGenerator modelGenerator) {
