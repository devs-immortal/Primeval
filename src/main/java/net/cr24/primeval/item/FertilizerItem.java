...
public class FertilizerItem extends WeightedItem {
    ...
    private final PrimevalFarmlandBlockFertilizerType type;

    public FertilizerItem(Settings settings, Weight weight, Size size, int fertilizeAmount, PrimevalFarmlandBlockFertilizerType type) {
