...
public class PrimevalKnifeItem extends PrimevalSwordItem {
    ...
    public PrimevalKnifeItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Settings settings, Weight weight, Size size) {
