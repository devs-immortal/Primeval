...
public class ItemDamagingRecipe implements CraftingRecipe {
    ...
    public boolean matches(CraftingRecipeInput craftingRecipeInput, World world) {
        if (craftingRecipeInput.getStackCount() != this.ingredients.size()) {
            ...
            return craftingRecipeInput.size() == 1 && this.ingredients.size() == 1 ? (this.ingredients.get(0)).test(craftingRecipeInput.getStackInSlot(0)) : craftingRecipeInput.getRecipeMatcher().isCraftable(this, null);
        }
    }
    ...
    @Override
    public DefaultedList<ItemStack> getRecipeRemainders(CraftingRecipeInput input) { //TODO
