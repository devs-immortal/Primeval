...
public class PrimevalWaterPlantBlock extends PlantBlock implements FluidFillable {
    ...
    public static final MapCodec<PrimevalWaterPlantBlock> CODEC = createCodec(PrimevalWaterPlantBlock::new);
    ...
    protected boolean canPlantOnTop(BlockState floor, BlockView world, BlockPos pos) {
        return floor.isIn(PrimevalTags.Blocks.MEDIUM_SOIL) || floor.isIn(PrimevalTags.Blocks.LIGHT_SOIL) || floor.isOf(PrimevalBlocks.STONE);
    }
