...
public class GrowingGrassBlock extends Block {
    ...
    protected boolean canGrow(int growthState, BlockState floorBlock) {
        switch (growthState) {
            case 0:
                return floorBlock.isIn(PrimevalTags.Blocks.LIGHT_SOIL) || floorBlock.isIn(PrimevalTags.Blocks.MEDIUM_SOIL) || floorBlock.isIn(PrimevalTags.Blocks.HEAVY_SOIL);
            case 1: case 2:
                return floorBlock.isIn(PrimevalTags.Blocks.MEDIUM_SOIL) || floorBlock.isIn(PrimevalTags.Blocks.HEAVY_SOIL);
            default:
                return floorBlock.isIn(PrimevalTags.Blocks.HEAVY_SOIL);
        }
    }
