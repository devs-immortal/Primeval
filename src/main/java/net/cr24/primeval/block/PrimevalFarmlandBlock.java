...
public class PrimevalFarmlandBlock extends SemiSupportedBlock {
    ...
    public PrimevalFarmlandBlock(Settings settings, float percentPerSide, Block resultBlock, Block[] sourceBlocks) {
        this(settings, percentPerSide, resultBlock, resultBlock, sourceBlocks);
    }

    public PrimevalFarmlandBlock(Settings settings, float percentPerSide, Block fallBlock, Block turnsTo, Block[] sourceBlocks) {
